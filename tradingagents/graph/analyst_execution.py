...
ANALYST_NODE_SPECS: Dict[str, AnalystNodeSpec] = {
    ...
    "social": AnalystNodeSpec(
        ...
        # that landed in v0.2.5 (sentiment_analyst now ingests the frozen
        # per-ticker source snapshot: company news, Google News, Reddit,
        # Telegram, and Google Trends, not just social media).
        key="social",
